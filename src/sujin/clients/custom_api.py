...
class CustomAPIClient:
    ...
    def _get_headers(self) -> Dict[str, str]:
        ...
        # Add Host header if specified in environment
        custom_host = os.environ.get('CUSTOM_HOST_HEADER')
        if custom_host:
    ...
    def chat_completion(
        ...
        """
        # Check if the base_url already includes the completions endpoint
